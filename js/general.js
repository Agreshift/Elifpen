    ...
    $('.form-ajax').each(function(){
        ...
        $(this).validate({
            submitHandler: function(form) {
                ...
                $submit_button.html('Gönderiliyor...');
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        $('.modal-result').html('Mesajınız başarıyla iletildi. En kısa sürede dönüş yapacağız.');
                        $('#result').modal('show');
                    ...
                    error: function(){
                        ...
                        $('.modal-result').html('Mesaj gönderilemedi. Lütfen telefonla ulaşın.');
                        $('#result').modal('show');
...
/*---------------------------------------------------------------------
 * Form doğrulama mesajları (TR) - Elif Pen
 *-------------------------------------------------------------------*/
if (window.jQuery && jQuery.validator) {
    jQuery.extend(jQuery.validator.messages, {
        ...
        minlength: jQuery.validator.format('En az {0} karakter girin.'),
        maxlength: jQuery.validator.format('En fazla {0} karakter girin.')
    });
}
